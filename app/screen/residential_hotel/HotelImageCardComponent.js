    ...
    render() {
        ...
        return (
            <View style={{ marginLeft: 0, marginRight: 10 }}>
                <View style={{ backgroundColor: "white", borderColor: "#e9e8e8",  borderStyle: "solid",borderWidth: 0.5 ,borderRadius: 10, overflow: 'hidden' }}>
                    ...
                    <View style={{ padding: 10, width: 300, flexDirection: "row" }}>
                        <View style={{flex: 8}}>
                            ...
                            <View style={{flexDirection: "row"}}>
                                <Entypo name="location-pin" size={12} color="grey" style={{paddingTop: 3}} />
                        ...
                        <View style={{flex: 2, marginTop: 5}}>
                            <Rating
                                ...
                                showRating={false}
                            />
                            <Text style={{fontSize: 10, color: "grey", paddingTop: 2}}>284 reviews</Text>
                        </View>
                    </View>
                </View>
            </View>
